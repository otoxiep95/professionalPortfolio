...
function fetchData() {
  var url = "https://professionalportfolio.albertopachecommd.com/wp-json/wp/v2/galleryproject?_embed";
...
function buildGallery(data) {
  data.forEach(function (project) {
    ...
    var projectBox = clone.querySelector(".project");
    ...
    dowloadingImage.src = project._embedded["wp:featuredmedia"][0].media_details.sizes.medium.source_url;
